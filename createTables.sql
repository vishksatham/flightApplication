...
CREATE TABLE USERS_vishksat (
    username varchar(20) PRIMARY KEY,
    hashedpass varbinary(144) NOT NULL, 
    balance int NOT NULL,
    canceled INT
);

CREATE TABLE RESERVATIONS_vishksat (
    rid INT PRIMARY KEY,
    paid INT NOT NULL,
    ...
    uname VARCHAR(20) REFERENCES USERS_vishksat(username) NOT NULL,
    flightID1 INT REFERENCES FLIGHTS(fid) NOT NULL,
    flightID2 INT REFERENCES FLIGHTS(fid)
); 